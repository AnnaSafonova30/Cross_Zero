...
zero_win = pygame.image.load("image/Zero_win.jpg")
cross_win = pygame.image.load("image/Cross_win.jpg")
zero = pygame.image.load("image/Zero.jpg")
table = pygame.image.load("image/table.jpg")
cross = pygame.image.load("image/Cross.jpg")
